(function () {
  ...
  function mount() {
    ...
    header.appendChild(el("p", null, "可以问我这篇文章相关问题"));
    var quota = el("span");
    ...
    appendMsg(messages, "bot", "你好呀～我是博客小精灵，有什么想聊的吗？");
    ...
    return { messages: messages, input: input, send: send, toggle: toggle, panel: panel, quota: quota };
  }
