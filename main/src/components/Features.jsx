  ...
  return (
    <div className="relative size-full">
      ...
      <div className="relative z-10 flex size-full flex-col justify-between p-5 text-blue-50">
        <div className="inline-block rounded-lg bg-black/50 px-3 py-2 backdrop-blur-sm">
          <h1 className="bento-title special-font text-yellow-300">{title}</h1>
          {description && (
            <p className="mt-3 max-w-64 text-xs md:text-base text-white font-semibold">{description}</p>
          )}
        </div>
