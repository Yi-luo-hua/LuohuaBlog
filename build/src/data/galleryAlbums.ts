...
export const galleryAlbums: GalleryAlbum[] = [
  {
    ...
    captionZh: '收藏番剧与截图的角落',
    captionEn: 'A corner for anime & screenshots',
    labelZh: '动漫',
    sections: [
      {
        title: '御坂美琴',
  ...
  },
  {
    ...
    placeholder: { emoji: '🌸' },
    captionZh: '生活碎片 · 待续',
    captionEn: 'Life fragments · coming soon',
    placeholderPage: true,
  },
  {
    id: 'tangwulin',
    placeholder: { emoji: '📷', className: 'gallery-placeholder--mint' },
    captionZh: '旅行与街景',
    captionEn: 'Travel & street views',
    placeholderPage: true,
  },
];
